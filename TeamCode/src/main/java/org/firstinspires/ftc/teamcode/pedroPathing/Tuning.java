...
public class Tuning extends SelectableOpMode {
    ...
    /** This creates a full stopShooter of the robot by setting the drive motors to run at 0 power. */
...
class ForwardVelocityTuner extends OpMode {
    ...
    public void init_loop() {
        ...
        telemetryM.debug("Press B on game pad 1 to stopShooter.");
     ...
     * game pad 1 will stopShooter the OpMode. This continuously records the RECORD_NUMBER most recent
...
class LateralVelocityTuner extends OpMode {
    ...
    public void init_loop() {
        ...
        telemetryM.debug("Press B on Gamepad 1 to stopShooter.");
        telemetryM.update(telemetry);
    ...
    /**
     * This runs the OpMode. At any point during the running of the OpMode, pressing B on
     * game pad1 will stopShooter the OpMode. This continuously records the RECORD_NUMBER most recent
...
class ForwardZeroPowerAccelerationTuner extends OpMode {
    ...
    public void init_loop() {
        ...
        telemetryM.debug("Then, it will cut power from the drivetrain and roll to a stopShooter.");
    ...
    /**
     * This runs the OpMode. At any point during the running of the OpMode, pressing B on
     * game pad 1 will stopShooter the OpMode. When the robot hits the specified velocity, the robot will
